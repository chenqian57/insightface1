...
# /home/qiujing/cqwork/insightface/recognition
# ./recognition
sys.path.append('/home/qiujing/cqwork/insightface/recognition')
# 将当前工作目录下的`./recognition`文件夹添加到Python模块搜索路径中
# 当代码中导入名为`embedding`的模块时，Python解释器就会在当前工作目录下的`./recognition`文件夹中查找该模块
